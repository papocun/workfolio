...
export default function LockedPagePlaceholder({
  ...
  return (
    <main className="max-w-[680px] mx-auto px-6 pt-8 sm:pt-10 pb-24 transition-colors duration-200">
      ...
      <div className="flex items-center justify-between mb-8 sm:mb-10">
        <span className="text-[12px] font-mono text-slate-400 dark:text-slate-500 lowercase tracking-normal">
          // {sectionLabel}
        </span>
        <span className="inline-flex items-center gap-1.5 font-mono text-[11px] text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/40 border border-amber-200/60 dark:border-amber-800/50 px-2 py-0.5 rounded-full">
      ...
      <div className="w-full rounded-2xl border border-slate-200/90 dark:border-slate-800/90 bg-white dark:bg-[#0f1422] p-8 sm:p-12 shadow-xs dark:shadow-xl transition-colors duration-200 flex flex-col items-center text-center">
        {/* Subtle Lock Icon */}
